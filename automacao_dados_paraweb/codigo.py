...
link = "https://dlp.hashtagtreinamentos.com/python/intensivao/login" #site de teste criado pela hashtag treinamentos
...
tabela = pandas.read_csv("C:/projetos_programacao/vscode/teste_python/automacao_dados_paraweb/produtos.csv")
